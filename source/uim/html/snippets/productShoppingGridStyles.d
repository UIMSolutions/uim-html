...
<div @safe class="container">
    <h3 @safe class="h3">shopping Demo-1 </h3>
    <div @safe class="row">
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid">
                <div @safe class="product-image">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo9/images/img-1.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo9/images/img-2.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" data-tip="Quick View"><i @safe class="fa fa-search"></i></a></li>
                        <li><a href="" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="" data-tip="Add to Cart"><i @safe class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                    <span @safe class="product-new-label">Sale</span>
                    <span @safe class="product-discount-label">20%</span>
                </div>
                <ul @safe class="rating">
                    <li @safe class="fa fa-star"></li>
                    <li @safe class="fa fa-star"></li>
                    <li @safe class="fa fa-star"></li>
                    <li @safe class="fa fa-star"></li>
                    <li @safe class="fa fa-star disable"></li>
                </ul>
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Women's Blouse</a></h3>
                    <div @safe class="price">$16.00
                        <span>$20.00</span>
                    </div>
                    <a @safe class="add-to-cart" href="">+ Add To Cart</a>
                </div>
            </div>
        </div>
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid">
                <div @safe class="product-image">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo9/images/img-3.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo9/images/img-4.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" data-tip="Quick View"><i @safe class="fa fa-search"></i></a></li>
                        <li><a href="" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
                    ...
                    <span @safe class="product-new-label">Sale</span>
                    <span @safe class="product-discount-label">50%</span>
                </div>
                <ul @safe class="rating">
                    <li @safe class="fa fa-star"></li>
                    <li @safe class="fa fa-star"></li>
                ...
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Men's Plain Tshirt</a></h3>
                    <div @safe class="price">$5.00
                        <span>$10.00</span>
                    </div>
                    <a @safe class="add-to-cart" href="">+ Add To Cart</a>
                </div>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid">
                <div @safe class="product-image">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo9/images/img-5.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo9/images/img-6.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" data-tip="Quick View"><i @safe class="fa fa-search"></i></a></li>
                        <li><a href="" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid">
                <div @safe class="product-image">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo9/images/img-7.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo9/images/img-8.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" data-tip="Quick View"><i @safe class="fa fa-search"></i></a></li>
                        <li><a href="" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
...
<div @safe class="container">
    <h3 @safe class="h3">shopping Demo-2 </h3>
    <div @safe class="row">
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid2">
                <div @safe class="product-image2">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo3/images/img-1.jpeg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo3/images/img-2.jpeg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#" data-tip="Quick View"><i @safe class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="#" data-tip="Add to Cart"><i @safe class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                    <a @safe class="add-to-cart" href="">Add to cart</a>
                ...
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Women's Designer Top</a></h3>
                    <span @safe class="price">$599.99</span>
                </div>
            </div>
        </div>
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid2">
              <div @safe class="product-image2">
                  <a href="#">
                      <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo3/images/img-3.jpeg">
                      <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo3/images/img-4.jpeg">
                  </a>
                  <ul @safe class="social">
                      <li><a href="#" data-tip="Quick View"><i @safe class="fa fa-eye"></i></a></li>
                      <li><a href="#" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
                ...
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Women's Yellow Top</a></h3>
                    <span @safe class="price">$699.99</span>
                </div>
            </div>
        </div>
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid2">
                <div @safe class="product-image2">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo3/images/img-5.jpeg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo3/images/img-6.jpeg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#" data-tip="Quick View"><i @safe class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid2">
                <div @safe class="product-image2">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo3/images/img-7.jpeg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo3/images/img-8.jpeg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#" data-tip="Quick View"><i @safe class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
...
<div @safe class="container">
    <h3 @safe class="h3">shopping Demo-3 </h3>
    <div @safe class="row">
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid3">
                <div @safe class="product-image3">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo4/images/img-1.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo4/images/img-2.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#"><i @safe class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="#"><i @safe class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                    <span @safe class="product-new-label">New</span>
                </div>
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Men's Blazer</a></h3>
                    <div @safe class="price">
                        $63.50
                        <span>$75.00</span>
                    </div>
                    <ul @safe class="rating">
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid3">
                <div @safe class="product-image3">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo4/images/img-3.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo4/images/img-4.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#"><i @safe class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="#"><i @safe class="fa fa-shopping-cart"></i></a></li>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid3">
                <div @safe class="product-image3">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo4/images/img-5.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo4/images/img-6.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#"><i @safe class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="#"><i @safe class="fa fa-shopping-cart"></i></a></li>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid3">
                <div @safe class="product-image3">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo4/images/img-7.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo4/images/img-8.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#"><i @safe class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="#"><i @safe class="fa fa-shopping-cart"></i></a></li>
...
<div @safe class="container">
    <h3 @safe class="h3">shopping Demo-4 </h3>
    <div @safe class="row">
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid4">
                <div @safe class="product-image4">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo5/images/img-1.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo5/images/img-2.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#" data-tip="Quick View"><i @safe class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
                    ...
                    <span @safe class="product-new-label">New</span>
                    <span @safe class="product-discount-label">-10%</span>
                </div>
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Women's Black Top</a></h3>
                    <div @safe class="price">
                        $14.40
                        <span>$16.00</span>
                    </div>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid4">
                <div @safe class="product-image4">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo5/images/img-3.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo5/images/img-4.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#" data-tip="Quick View"><i @safe class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
                    ...
                    <span @safe class="product-discount-label">-12%</span>
                </div>
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Men's Blue Shirt</a></h3>
                    <div @safe class="price">
                        $17.60
                        <span>$20.00</span>
                    </div>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid4">
                <div @safe class="product-image4">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo5/images/img-5.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo5/images/img-6.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#" data-tip="Quick View"><i @safe class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid4">
                <div @safe class="product-image4">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo5/images/img-7.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo5/images/img-8.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="#" data-tip="Quick View"><i @safe class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
...
<div @safe class="container">
    <h3 @safe class="h3">shopping Demo-5 </h3>
    <div @safe class="row">
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid5">
                <div @safe class="product-image5">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo11/images/img-1.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo11/images/img-2.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" data-tip="Quick View"><i @safe class="fa fa-search"></i></a></li>
                        <li><a href="" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
                    ...
                    <a href="#" @safe class="select-options"><i @safe class="fa fa-arrow-right"></i> Select Options</a>
                </div>
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Men's Sweat Shirt</a></h3>
                    <div @safe class="price">$11.00 - $15.00</div>
                </div>
            </div>
        </div>
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid5">
                <div @safe class="product-image5">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo11/images/img-3.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo11/images/img-4.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" data-tip="Quick View"><i @safe class="fa fa-search"></i></a></li>
                        <li><a href="" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
                ...
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Women's Shirt</a></h3>
                    <div @safe class="price">$10.00 - $12.00</div>
                </div>
            </div>
        </div>
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid5">
                <div @safe class="product-image5">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo11/images/img-5.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo11/images/img-6.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" data-tip="Quick View"><i @safe class="fa fa-search"></i></a></li>
                        <li><a href="" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid5">
                <div @safe class="product-image5">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo11/images/img-7.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo11/images/img-8.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" data-tip="Quick View"><i @safe class="fa fa-search"></i></a></li>
                        <li><a href="" data-tip="Add to Wishlist"><i @safe class="fa fa-shopping-bag"></i></a></li>
...
<div @safe class="container">
    <h3 @safe class="h3">shopping Demo-6 </h3>
    <div @safe class="row">
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid6">
                <div @safe class="product-image6">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo10/images/img-1.jpg">
                    </a>
                </div>
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Men's Shirt</a></h3>
                    <div @safe class="price">$11.00
                        <span>$14.00</span>
                    </div>
                </div>
                <ul @safe class="social">
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid6">
                <div @safe class="product-image6">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo10/images/img-2.jpg">
                    </a>
                </div>
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Women's Red Top</a></h3>
                    <div @safe class="price">$8.00
                        <span>$12.00</span>
                    </div>
                </div>
                <ul @safe class="social">
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid6">
                <div @safe class="product-image6">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo10/images/img-3.jpg">
                    </a>
                </div>
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Men's Shirt</a></h3>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid6">
                <div @safe class="product-image6">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo10/images/img-4.jpg">
                    </a>
                </div>
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Men's Shirt</a></h3>
...
<div @safe class="container">
    <h3 @safe class="h3">shopping Demo-7 </h3>
    <div @safe class="row">
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid7">
                <div @safe class="product-image7">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo8/images/img-1.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo8/images/img-2.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" @safe class="fa fa-search"></a></li>
                        <li><a href="" @safe class="fa fa-shopping-bag"></a></li>
                        <li><a href="" @safe class="fa fa-shopping-cart"></a></li>
                    </ul>
                    <span @safe class="product-new-label">New</span>
                </div>
                <div @safe class="product-content">
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid7">
                <div @safe class="product-image7">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo8/images/img-3.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo8/images/img-4.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" @safe class="fa fa-search"></a></li>
                        <li><a href="" @safe class="fa fa-shopping-bag"></a></li>
                ...
                <div @safe class="product-content">
                    <h3 @safe class="title"><a href="#">Women's White Shirt</a></h3>
                    <ul @safe class="rating">
                        <li @safe class="fa fa-star"></li>
                        <li @safe class="fa fa-star"></li>
                        <li @safe class="fa fa-star"></li>
                    ...
                    <div @safe class="price">$15.00</div>
                </div>
            </div>
        </div>
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid7">
                <div @safe class="product-image7">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo8/images/img-5.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo8/images/img-6.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" @safe class="fa fa-search"></a></li>
                        <li><a href="" @safe class="fa fa-shopping-bag"></a></li>
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid7">
                <div @safe class="product-image7">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo8/images/img-7.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo8/images/img-8.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" @safe class="fa fa-search"></a></li>
                        <li><a href="" @safe class="fa fa-shopping-bag"></a></li>
...
<div @safe class="container">
    <h3 @safe class="h3">shopping Demo-8 </h3>
    <div @safe class="row">
        <div @safe class="col-md-4 col-sm-6">
            <div @safe class="product-grid8">
                <div @safe class="product-image8">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo7/images/img-1.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo7/images/img-2.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" @safe class="fa fa-search"></a></li>
                        <li><a href="" @safe class="fa fa-shopping-bag"></a></li>
                ...
                <div @safe class="product-content">
                    ...
                    <span @safe class="product-shipping">Free Shipping</span>
                    <h3 @safe class="title"><a href="#">Women's Plain Top</a></h3>
                    <a @safe class="all-deals" href="">See all deals <i @safe class="fa fa-angle-right icon"></i></a>
                </div>
            </div>
        </div>
        <div @safe class="col-md-4 col-sm-6">
            <div @safe class="product-grid8">
                <div @safe class="product-image8">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo7/images/img-3.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo7/images/img-4.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" @safe class="fa fa-search"></a></li>
                        <li><a href="" @safe class="fa fa-shopping-bag"></a></li>
                    ...
                    <span @safe class="product-discount-label">-30%</span>
                </div>
                <div @safe class="product-content">
                    <div @safe class="price">£ 7.00
                        <span>£ 10.00</span>
                    </div>
                    <span @safe class="product-shipping">Free Shipping</span>
                    <h3 @safe class="title"><a href="#">Women's Designer Top</a></h3>
        ...
        <div @safe class="col-md-4 col-sm-6">
            <div @safe class="product-grid8">
                <div @safe class="product-image8">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo7/images/img-5.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo7/images/img-6.jpg">
                    </a>
                    <ul @safe class="social">
                        <li><a href="" @safe class="fa fa-search"></a></li>
                        <li><a href="" @safe class="fa fa-shopping-bag"></a></li>
...
<div @safe class="container">
    <h3 @safe class="h3">shopping Demo-9 </h3>
    <div @safe class="row">
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid9">
                <div @safe class="product-image9">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo6/images/img-1.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo6/images/img-2.jpg">
                    </a>
                    <a href="#" @safe class="fa fa-search product-full-view"></a>
                </div>
                <div @safe class="product-content">
                    <ul @safe class="rating">
                        <li @safe class="fa fa-star"></li>
                    ...
                    <h3 @safe class="title"><a href="#">Women's Top</a></h3>
                    <div @safe class="price"> $12.60 - $40.53</div>
                    <a @safe class="add-to-cart" href="">VIEW PRODUCTS</a>
                </div>
            </div>
        </div> 
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid9">
                <div @safe class="product-image9">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo6/images/img-3.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo6/images/img-4.jpg">
                    </a>
                    <a href="#" @safe class="fa fa-search product-full-view"></a>
                </div>
                <div @safe class="product-content">
                    ...
                    <h3 @safe class="title"><a href="#">Men's Shirt</a></h3>
                    <div @safe class="price"> $10.20 </div>
                    <a @safe class="add-to-cart" href="">READ MORE</a>
                </div>
            </div>
        </div>
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid9">
                <div @safe class="product-image9">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo6/images/img-5.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo6/images/img-6.jpg">
                    </a>
                    <a href="#" @safe class="fa fa-search product-full-view"></a>
                </div>
                <div @safe class="product-content">
        ...
        <div @safe class="col-md-3 col-sm-6">
            <div @safe class="product-grid9">
                <div @safe class="product-image9">
                    <a href="#">
                        <img @safe class="pic-1" src="http://bestjquery.com/tutorial/product-grid/demo6/images/img-7.jpg">
                        <img @safe class="pic-2" src="http://bestjquery.com/tutorial/product-grid/demo6/images/img-8.jpg">
                    </a>
                    <a href="#" @safe class="fa fa-search product-full-view"></a>
                </div>
                <div @safe class="product-content">
